								...
								@if(Helper::getAllProductFromCart())
									@foreach(Helper::getAllProductFromCart() as $key=>$cart)
										<tr>
											...
											<td class="price" data-title="Price"><span class="money">₹{{$cart['price']}}</span></td>
											...
											<td class="total-amount cart_single_price" data-title="Total"><span>₹{{number_format($cart['amount'],2)}}</span></td>
					...
					<div class="total-amount">
						<div class="row">
							...
							<div class="col-lg-4 col-md-7 col-12">
								<div class="right">
									<ul>
										<li class="order_subtotal" data-price="{{Helper::totalCartPrice()}}">Cart Subtotal<span>₹{{number_format($cart['amount'],2)}}</span></li>
