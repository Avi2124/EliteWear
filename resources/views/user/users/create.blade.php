...
<div class="card">
    ...
    <div class="card-body">
      <form method="post" action="{{route('users.store')}}">
        ...
        @php 
        // Fetch unique roles from roles table or distinct roles from users
        $roles = DB::table('roles')->pluck('role'); // If you have a 'roles' table
        if ($roles->isEmpty()) {
            $roles = DB::table('users')->distinct()->pluck('role'); // Fallback to users table
        }
        @endphp
